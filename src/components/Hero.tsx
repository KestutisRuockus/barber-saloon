...
const Hero = () => {
  return (
    <div className="w-full lg:w-[90%] xl:w-[80%] mx-auto font-quicksand bg-darkest-bg flex flex-col-reverse md:flex-row gap-8 md:gap-0 justify-center items-center overflow-hidden relative z-20 px-16 md:px-32 py-12">
      <div className="text-white z-20 md:pl-24">
