    ...
    <div className="w-full lg:w-[90%] xl:w-[80%] mx-auto font-quicksand bg-darkest-bg flex flex-col-reverse md:flex-row gap-8 md:gap-0 justify-center items-center relative z-20 px-16 md:px-32 py-12">
      ...
      >
        ...
        <button
          ...
          className="uppercase bg-light-dark-bg rounded-lg py-2.5 px-8 mt-4 cursor-pointer hover:bg-hover-bg hover:text-hover-text transition-colors duration-300"
        >
          Book appointment
        </button>
      </motion.div>
